...
#       to file issues and suggest changes to the template instead.
#
##############################################################################
...
if ! "$cygwin" && ! "$darwin" && ! "$nonstop" ; then
    case $MAX_FD in #(
      max*|Max*) # In POSIX sh, ulimit -H is undefined. That's why the result is checked to see if it worked.
        MAX_FD=$( ulimit -H -n ) ||
